...
export const registerForTechFellowship = asyncErrorMiddleware(
    async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            if (alreadyRegistered) return next(new ErrorHandler("Already Registered for this Cohort", 400))
            ...
            const applicantDetails = await prisma.user.findFirst({
              ...
              const fellowshipMailData = { shortName: "IOTB-Techpreneur", firstName: name }
